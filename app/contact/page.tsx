  ...
  return (
    <>
      <div className="w-full  pb-10">
        ...
        <div className="max-w-[1200px] mx-auto px-4 py-12 flex lg:flex-row flex-col justify-center items-center gap-12">
          {/* Left Section */}
          <div className="flex-1">
            {/* Information About Us */}
            <h2 className="text-[36px] font-bold text-[#151875] mb-4">
              Information About Us
            </h2>
